...
def cli():
    ...
    #Backup the first five issues
    parser.add_argument('-f', '--first-five',
                        dest='fif_issues',
                        action='store_const',
                        default=False,
                        const=True,
                        help = 'Backup the first five issues')
    ...
    parser.add_argument('-s', '--specify-board',  # 备份指定的board 
                        ...
                        'If -m args specified, do not specify -s args')
